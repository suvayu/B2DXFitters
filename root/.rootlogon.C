...
lhcbStyle->SetMarkerStyle(24);
lhcbStyle->SetMarkerSize(0.8);

// label offsets
lhcbStyle->SetLabelOffset(0.005);
...
lhcbStyle->SetStatX(0.5);
lhcbStyle->SetStatY(1.0);
