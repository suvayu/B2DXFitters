def getconfig() :
    ...
    configdict["AdditionalDataCuts"] = "lab2_TAU>0&&lab0_L0HadronDecision_TOS==1"
    configdict["AdditionalMCCuts"] = "lab2_TAU>0&&lab0_L0HadronDecision_TOS==1"
    ...
    configdict["nLbLcKEvts"]           = [15.0/2.0*0.46, 15.0/2.0*0.46,
                                          2.0/2.0*0.46,  2.0/2.0*0.46,
                                          4.0/2.0*0.46,  4.0/2.0*0.46,
                                          0, 0,
                                          0, 0]
    
    configdict["nLbLcPiEvts"]           = [11.0/2.0*0.46, 11.0/2.0*0.46,
                                           1.0/2.0*0.46,  1.0/2.0*0.46,
                                           3.0/2.0*0.46,  3.0/2.0*0.46,
                                           0, 0,
                                           0, 0]
    
    
    configdict["nBdDKEvts"]            = [17.0/2.0*0.46, 17.0/2.0*0.46,
                                          0.0,           0.0,
                                          5.0/2.0*0.46,  5.0/2.0*0.46,
                                          0, 0,
                                          0, 0]
    
    configdict["nBdDPiEvts"]            = [14.0/2.0*0.46, 14.0/2.0*0.46,
                                           0.0,           0.0,
                                           3.0/2.0*0.46,  3.0/2.0*0.46,
                                           3.0/2.0*0.46,  3.0/2.0*0.46,
                                           0, 0]
