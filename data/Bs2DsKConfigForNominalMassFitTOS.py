def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.53, 2.0*0.53,  4.0*0.53,  0.0*0.53,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.53, 1.0*0.53,  3.0*0.53,  0.0*0.53,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.53, 0.0*0.53,  5.0*0.53,  0.0*0.53,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.53, 0.0*0.53,  3.0*0.53,  3.0*0.53,  0.0]            
