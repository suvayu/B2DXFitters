def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.4, 2.0*0.4,  4.0*0.4,  0.0*0.4,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.4, 1.0*0.4,  3.0*0.4,  0.0*0.4,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.4, 0.0*0.4,  5.0*0.4,  0.0*0.4,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.4, 0.0*0.4,  3.0*0.4,  3.0*0.4,  0.0]
