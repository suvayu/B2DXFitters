def getconfig() :
    ...
    # year of data taking
    configdict["YearOfDataTaking"] = {"2012"} #,"2012"} 
    ...
    configdict["GlobalWeight"] = {"2011": {"NonRes" : {"Down":0.746768, "Up":0.606189},
                                            "PhiPi"  : {"Down":0.774299, "Up":0.626628},
                                            "KstK"   : {"Down":0.739354, "Up":0.584960}, 
                                            "KPiPi"  : {"Down":0.242023, "Up":0.189730},  
                                            "PiPiPi" : {"Down":0.376287, "Up":0.274021}},
                                   "2012": {"NonRes" : {"Down":0.921612, "Up":0.979463},
                                            "PhiPi"  : {"Down":0.878538, "Up":0.936504},
                                            "KstK"   : {"Down":0.888777, "Up":0.948957},
                                            "KPiPi"  : {"Down":0.804338, "Up":0.793737},
                                            "PiPiPi" : {"Down":0.972961, "Up":1.000000}}}
    ...
    configdict["BsSignalShape"]["R"]       = {"Run1": {"NonRes":1.0815e+00,  "PhiPi":1.0826e+00,  "Kstk":1.0821e+00,  "KPiPi":1.0774e+00,  "PiPiPi":1.0696e+00},  "Fixed":True}
    ...
    configdict["DsSignalShape"]["R"]       = {"Run1": {"NonRes":1.0399e+00,  "PhiPi":1.0559e+00,   "KstK":1.0532e+00,  "KPiPi":1.0468e+00,  "PiPiPi":1.0493e+00}, "Fixed":True}
    ...
    configdict["BsCombinatorialShape"]["cB1"]   = {"Run1": {"NonRes":-7.5211e-03,  "PhiPi":-6.0873e-03,  "KstK":-7.3392e-03, "KPiPi":-6.0361e-03, "PiPiPi":-6.5277e-03},"Fixed": False}
    ...
    configdict["DsCombinatorialShape"]["cD"]      = {"Run1": {"NonRes":-5.4329e-03,  "PhiPi":-7.8642e-03,  "KstK":-7.2652e-03, "KPiPi":-6.0743e-03, "PiPiPi":-4.1877e-03},"Fixed":False}
