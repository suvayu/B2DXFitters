def getconfig() :
    ...
    configdict["Yields"]["Bd2DPi"]            = {"2011": {"NonRes":1.0,     "PhiPi":0.0,    "KstK":0.2,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":1.6,     "PhiPi":0.1,    "KstK":0.3,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Bd2DK"]             = {"2011": {"NonRes":3.3,     "PhiPi":0.1,    "KstK":0.5,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":3.7,     "PhiPi":0.3,    "KstK":0.8,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Lb2LcPi"]           = {"2011": {"NonRes":2.8,     "PhiPi":0.6,    "KstK":0.9,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":5.3,     "PhiPi":1.0,    "KstK":1.7,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Lb2LcK"]            = {"2011": {"NonRes":6.2,     "PhiPi":1.3,    "KstK":2.0,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":13.2,    "PhiPi":2.5,    "KstK":4.2,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
