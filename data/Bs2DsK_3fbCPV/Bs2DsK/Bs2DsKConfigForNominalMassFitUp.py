def getconfig() :
    ...
    configdict["Yields"]["Bd2DPi"]            = {"2011": {"NonRes":0.7,     "PhiPi":0.0,    "KstK":0.1,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":1.6,     "PhiPi":0.0,    "KstK":0.3,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Bd2DK"]             = {"2011": {"NonRes":1.7,     "PhiPi":0.1,    "KstK":0.3,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":3.8,     "PhiPi":0.3,    "KstK":0.8,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Lb2LcPi"]           = {"2011": {"NonRes":2.1,     "PhiPi":0.5,    "KstK":0.6,    "KPiPi":0.0,    "PiPiPi":0.0},
                                                 "2012": {"NonRes":5.4,     "PhiPi":1.0,    "KstK":1.7,    "KPiPi":0.0,    "PiPiPi":0.0}, "Fixed":True}
    configdict["Yields"]["Lb2LcK"]            = {"2011": {"NonRes":4.7,     "PhiPi":1.0,    "KstK":1.5,    "KPiPi":0.0,    "PiPiPi":0.0},
