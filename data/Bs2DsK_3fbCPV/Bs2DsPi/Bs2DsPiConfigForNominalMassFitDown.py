def getconfig() :
    ...
    configdict["BasicVariables"]["BDTG"]          = { "Range" : [ 0.2,    1.0     ], "InputName" : "BDTGResponse_3"}
    ...
    configdict["Yields"]["Bd2DPi"]          = {"2011": { "NonRes":28.8,    "PhiPi":2.0,     "KstK":5.8,     "KPiPi":5.6,     "PiPiPi":0.0},
                                               "2012": { "NonRes":50.1,    "PhiPi":3.8,     "KstK":10.6,    "KPiPi":10.4,    "PiPiPi":0.0},  "Fixed":True}
    ...
    configdict["Yields"]["Lb2LcPi"]         = {"2011": { "NonRes":80.0,    "PhiPi":17.7,    "KstK":26.2,    "KPiPi":0.4,     "PiPiPi":0.0},
                                               "2012": { "NonRes":170.3,   "PhiPi":32.3,    "KstK":53.0,    "KPiPi":1.8,     "PiPiPi":0.0},  "Fixed":True}

    configdict["Yields"]["Bs2DsK"]          = {"2011": { "NonRes":17.4,    "PhiPi":44.5,    "KstK":23.8,    "KPiPi":12.3,    "PiPiPi":25.5},
                                               "2012": { "NonRes":42.7,    "PhiPi":91.7,    "KstK":60.3,    "KPiPi":22.3,    "PiPiPi":56.8}, "Fixed":True}
