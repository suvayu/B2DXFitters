def getconfig() :
    ...
    configdict["Yields"]["Bd2DPi"]          = {"2011": { "NonRes":21.6,    "PhiPi":1.5,     "KstK":4.4,     "KPiPi":4.2,     "PiPiPi":0.0},
                                               "2012": { "NonRes":50.4,    "PhiPi":3.9,     "KstK":10.7,    "KPiPi":10.7,    "PiPiPi":0.0},  "Fixed":True}
    ...
    configdict["Yields"]["Lb2LcPi"]         = {"2011": { "NonRes":60.0,    "PhiPi":13.3,    "KstK":19.7,    "KPiPi":0.3,     "PiPiPi":0.0},
                                               "2012": { "NonRes":170.0,   "PhiPi":32.6,    "KstK":54.7,    "KPiPi":1.8,     "PiPiPi":0.0},  "Fixed":True}

    configdict["Yields"]["Bs2DsK"]          = {"2011": { "NonRes":13.1,    "PhiPi":44.5,    "KstK":23.8,    "KPiPi":12.3,    "PiPiPi":25.5},
                                               "2012": { "NonRes":43.7,    "PhiPi":91.7,    "KstK":60.3,    "KPiPi":22.3,    "PiPiPi":56.7}, "Fixed":True}
