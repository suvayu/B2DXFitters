def getconfig() :
    ...
    #expected Events
    configdict["BdDPiEvents"]  = [374.0*0.58, 6.0*0.58,  93.0*0.58, 30.0*0.58, 0.0*0.58]
    configdict["LbLcPiEvents"] = [290.0*0.58, 36.0*0.58, 69.0*0.58, 1.0*0.58,  0.0*0.58] #[312.0, 38.0, 69.0, 17.0,  0.0] #[301.0, 30.0, 68.0, 0.0,  0.0]
    configdict["BsDsKEvents"]  = [40.0*0.58,  47.0*0.58, 40.0*0.58, 8.0*0.58,  21.0*0.58]
