def getconfig() :
    ...
    #expected Events
    configdict["BdDPiEvents"]  = [374.0*0.9, 6.0*0.9,  93.0*0.9, 30.0*0.9, 0.0*0.9]
    configdict["LbLcPiEvents"] = [290.0*0.9, 36.0*0.9, 69.0*0.9, 1.0*0.9,  0.0*0.9] #[312.0, 38.0, 69.0, 17.0,  0.0] #[301.0, 30.0, 68.0, 0.0,  0.0]
    configdict["BsDsKEvents"]  = [40.0*0.9,  47.0*0.9, 40.0*0.9, 8.0*0.9,  21.0*0.9]
