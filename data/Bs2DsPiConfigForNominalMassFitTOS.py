def getconfig() :
    ...
    #expected Events
    configdict["BdDPiEvents"]  = [374.0*0.42, 6.0*0.42,  93.0*0.42, 30.0*0.42, 0.0*0.42]
    configdict["LbLcPiEvents"] = [290.0*0.42, 36.0*0.42, 69.0*0.42, 1.0*0.42,  0.0*0.42] #[312.0, 38.0, 69.0, 17.0,  0.0] #[301.0, 30.0, 68.0, 0.0,  0.0]
    configdict["BsDsKEvents"]  = [40.0*0.42,  47.0*0.42, 40.0*0.42, 8.0*0.42,  21.0*0.42]
