# personality for 2011 Paper - mode DsPi
{
	...
	'GammaCombBkg':  +1.20036e+00,
	'DGammaCombBkg': +1.24195e+00,
	'CombBkg_D':	 -9.13509e-01,
        'FitRanges': {
		'time':     [0.4, 15.],
		'timeerr':  [1e-6, 0.25],
		'mistag':   [0., 0.5],
        ...
        'DecayTimeErrorTemplates': {
                'Bs2DsK': {
                    'File': os.environ['B2DXFITTERSROOT']+'/data/workspace/MDFitter/template_Data_Terr_BsDsPi_BDTGA.root',
                    'Workspace': 'workspace',
