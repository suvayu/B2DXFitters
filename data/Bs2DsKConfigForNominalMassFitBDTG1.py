def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0/2.0*0.60, 15.0/2.0*0.60,
                                          2.0/2.0*0.60,  2.0/2.0*0.60,
                                          4.0/2.0*0.60,  4.0/2.0*0.60,
                                          0, 0,
                                          0, 0]
    
    configdict["nLbLcPiEvts"]           = [11.0/2.0*0.60, 11.0/2.0*0.60,
                                           1.0/2.0*0.60,  1.0/2.0*0.60,
                                           3.0/2.0*0.60,  3.0/2.0*0.60,
                                           0, 0,
                                           0, 0]
    
    
    configdict["nBdDKEvts"]            = [17.0/2.0*0.60, 17.0/2.0*0.60,
                                          0.0/2.0*0.60,  0.0/2.0*0.60,
                                          5.0/2.0*0.60,  5.0/2.0*0.60,
                                          0, 0,
                                          0, 0]
    
    configdict["nBdDPiEvts"]            = [14.0/2.0*0.60, 14.0/2.0*0.6,
                                           0.0/2.0*0.60,  0.0/2.0*0.6,
                                           3.0/2.0*0.60,  3.0/2.0*0.6,
                                           3.0/2.0*0.60,  3.0/2.0*0.6,
                                           0, 0]
