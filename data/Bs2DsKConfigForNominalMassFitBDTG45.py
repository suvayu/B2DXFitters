def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.95, 2.0*0.95,  4.0*0.95,  0.0*0.95,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.95, 1.0*0.95,  3.0*0.95,  0.0*0.95,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.95, 0.0*0.95,  5.0*0.95,  0.0*0.95,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.95, 0.0*0.95,  3.0*0.95,  3.0*0.95,  0.0]
