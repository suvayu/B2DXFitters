def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.75, 2.0*0.75,  4.0*0.75,  0.0*0.75,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.75, 1.0*0.75,  3.0*0.75,  0.0*0.75,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.75, 0.0*0.75,  5.0*0.75,  0.0*0.75,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.75, 0.0*0.75,  3.0*0.75,  3.0*0.75,  0.0]
