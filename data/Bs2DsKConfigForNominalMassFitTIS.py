def getconfig() :
    ...
    configdict["AdditionalDataCuts"] = "lab2_TAU>0&&lab0_L0HadronDecision_TOS==0"
    configdict["AdditionalMCCuts"] = "lab2_TAU>0&&lab0_L0HadronDecision_TOS==0"
    ...
    configdict["nLbLcKEvts"]           = [15.0/2.0*0.54, 15.0/2.0*0.54,
                                          2.0/2.0*0.54,  2.0/2.0*0.54,
                                          4.0/2.0*0.54,  4.0/2.0*0.54,
                                          0, 0,
                                          0, 0]
    
    configdict["nLbLcPiEvts"]           = [11.0/2.0*0.54, 11.0/2.0*0.54,
                                           1.0/2.0*0.54,  1.0/2.0*0.54,
                                           3.0/2.0*0.54,  3.0/2.0*0.54,
                                           0, 0,
                                           0, 0]
    
    
    configdict["nBdDKEvts"]            = [17.0/2.0*0.54, 17.0/2.0*0.54,
                                          0.0,           0.0,
                                          5.0/2.0*0.54,  5.0/2.0*0.54,
                                          0, 0,
                                          0, 0]
    
    configdict["nBdDPiEvts"]            = [14.0/2.0*0.54, 14.0/2.0*0.54,
                                           0.0,           0.0,
                                           3.0/2.0*0.54,  3.0/2.0*0.54,
                                           3.0/2.0*0.54,  3.0/2.0*0.54,
                                           0, 0]
