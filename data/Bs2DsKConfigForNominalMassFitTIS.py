def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.47, 2.0*0.47,  4.0*0.47,  0.0*0.47,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.47, 1.0*0.47,  3.0*0.47,  0.0*0.47,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.47, 0.0*0.47,  5.0*0.47,  0.0*0.47,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.47, 0.0*0.47,  3.0*0.47,  3.0*0.47,  0.0]
