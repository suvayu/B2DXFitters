def getconfig() :
    ...
    configdict["nLbLcKEvts"]           = [15.0*0.9, 2.0*0.9,  4.0*0.9,  0.0*0.9,  0.0]
    configdict["nLbLcPiEvts"]          = [11.0*0.9, 1.0*0.9,  3.0*0.9,  0.0*0.9,  0.0]
    configdict["nBdDKEvts"]            = [17.0*0.9, 0.0*0.9,  5.0*0.9,  0.0*0.9,  0.0]
    configdict["nBdDPiEvts"]           = [14.0*0.9, 0.0*0.9,  3.0*0.9,  3.0*0.9,  0.0]
