def getconfig() :
    ...
    #expected Events
    configdict["BdDPiEvents"]  = [374.0*0.95, 6.0*0.95,  93.0*0.95, 30.0*0.95, 0.0*0.95]
    configdict["LbLcPiEvents"] = [290.0*0.95, 36.0*0.95, 69.0*0.95, 1.0*0.95,  0.0*0.95] #[312.0, 38.0, 69.0, 17.0,  0.0] #[301.0, 30.0, 68.0, 0.0,  0.0]
    configdict["BsDsKEvents"]  = [40.0*0.95,  47.0*0.95, 40.0*0.95, 8.0*0.95,  21.0*0.95]
