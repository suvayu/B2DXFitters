def getconfig() :
    ...
    configdict["BsCombinatorialShape"]["cB"]   = {"2011":{"NonRes":-1.1530e-03,  "PhiPi":-9.2354e-04,  "KstK":-1.3675e-03, "KPiPi":-9.8158e-04, "PiPiPi":-1.0890e-03}, "Fixed":False}

    configdict["DsCombinatorialShape"] = {}
    configdict["DsCombinatorialShape"]["type"]  = "ExponentialPlusSignal"
    configdict["DsCombinatorialShape"]["cD"]         = {"2011": {"NonRes":-4.4329e-03,  "PhiPi":-8.8642e-03,  "KstK":-5.2652e-03, "KPiPi":-1.0743e-03, "PiPiPi":-1.1877e-03}, "Fixed":False}
    configdict["DsCombinatorialShape"]["fracCombD"]   = {"2011": {"NonRes":4.3067e-01,   "PhiPi":6.5400e-01,   "KstK":3.7409e-01,  "KPiPi":1.0,         "PiPiPi":1.0},         
    ...
    configdict["PIDKCombinatorialShape"]["fracPIDK"]   = { "2011":{"fracPIDK1":0.5, "fracPIDK2":0.5}, "Fixed":False }
    ...
    configdict["Bd2Ds(st)XShape"]["name"]    = "Bd2DsK"
    configdict["Bd2Ds(st)XShape"]["scaleSigma"] = { "2011": {"frac1": 0.998944636665, "frac2":1.00022181515}}

    #                                                                                                                                                                                 
    configdict["AdditionalParameters"] = {}
    configdict["AdditionalParameters"]["g1_f1_frac"] = { "CentralValue":1.0, "Range":[0.0,1.0], "Fixed":True}
    configdict["AdditionalParameters"]["g2_f1_frac"] = { "CentralValue":0.5, "Range":[0.0,1.0], "Fixed":False}
    configdict["AdditionalParameters"]["g2_f2_frac"] = { "CentralValue":0.5, "Range":[0.0,1.0], "Fixed":True}
    configdict["AdditionalParameters"]["g3_f1_frac"] = { "CentralValue":0.75,"Range":[0.0,1.0], "Fixed":True}
    configdict["AdditionalParameters"]["g5_f1_frac"] = { "CentralValue":0.5, "Range":[0.0,1.0], "Fixed":False}
