...
# DATA FILES
filesDir      = '../data'
dataFileName  = '2010DataNtuple_Bd2DPi.root'
...
#------------------------------------------------------------------------------
def runBdMassFitterOnData( debug ) :
    ...
    fitter.setDataSet( join( filesDir, dataFileName ), 'data' )
...
if __name__ == '__main__' :
    ...
    runBdMassFitterOnData( options.debug )
