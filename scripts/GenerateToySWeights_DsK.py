...
def runBsDsKGenerator( debug, single, configName, numberOfToys, numberOfEvents ) :
    ...
    #------------------------------------------------- Signal -----------------------------------------------------#
        ...
        #The Bs->DsK - mistag
        mistag_signal = Bs2Dsh2011TDAnaModels.GetRooKeysPdfFromWorkspace(workspace_mistag,TString("MistagPdf_signal_BDTGA"), debug)
        ...
        sinh_signal = DecRateCoeff('signal_sinh', 'signal_sinh', flag | DecRateCoeff.CPEven,
        ...
        sin_signal  = DecRateCoeff('signal_sin',  'signal_sin',  flag | DecRateCoeff.CPOdd,
                                   fChargeMap, bTagMap,  Sbar_signal, S_signal,    *otherargs_signal)
        ...
        terr_signal = terr_signal #Bs2Dsh2011TDAnaModels.GetRooHistPdfFromWorkspace(workspace_mistag,TString("TimeErrorPdf_signal_BDTGA"), debug)
        terr_signal.SetName("terr_signal")
    ...
    #------------------------------------------------- Bs -> DsPi ----------------------------------------------------# 
        ...
        C_dspi    = RooRealVar('C_dspi', 'C coeff. dspi', 0.)
    ...
    #------------------------------------------------- Total bkg ----------------------------------------------------#
        ...
        if single :
            ...
            canv_Bmistag = TCanvas("canv_Bmistag","canv_Btag")
