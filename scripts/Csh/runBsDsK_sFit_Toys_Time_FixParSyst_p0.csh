...
set outputprefix = 'DsK_Toys_Full_TimeFitResult_2kSample_FixParSyst_p0_'
...
while ($thissample < $2) 
    ...
    python runBs2DsKCPAsymmObsFitterOnData.py --toys --pereventmistag --configName Bs2DsKConfigForFixedParamSyst_p0 --pathToys $dir$inputprefix$thissamplestr$inputsuffix >& $dir$outputprefix$thissamplestr$outputsuffix 
