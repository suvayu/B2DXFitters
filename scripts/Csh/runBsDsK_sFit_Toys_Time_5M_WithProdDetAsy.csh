set dirinput =  '/afs/cern.ch/work/g/gligorov/public/Bs2DsKToys/For1fbPaper/Gamma70_WProdDetAsy_NoKFactors_5M_2T_MD/sWeightsForTimeFit/Nominal/'
set diroutput = '/afs/cern.ch/work/g/gligorov/public/Bs2DsKToys/For1fbPaper/Gamma70_WProdDetAsy_NoKFactors_5M_2T_MD/TimeFitResults/Nominal/'
...
while ($thissample < $2) 
    ...
    python runBs2DsKCPAsymmObsFitterOnData.py --pereventmistag --pereventterr --configName Bs2DsKConfigForNominalGammaFitToys5M_WithProdDetAsy --toys --configNameMD Bs2DsKConfigForNominalMassFitToys5M --pathName $dirinput$inputprefix$thissamplestr$inputsuffix --save $diroutput$timeplotprefix$thissamplestr$inputsuffix >& $diroutput$outputprefix$thissamplestr$outputsuffix
