...
while ($thissample < $2) 
    ...
    python runBsDsKMassFitterOnData3D5M.py --debug --merge -m both -o all --configName Bs2DsKConfigForFixedParamSyst_Backgrounds_MassFitToys5M --fileName /afs/cern.ch/work/a/adudziak/public/workspace/DsKNoteV11/work_dsk_pid_53005800_PIDK5_5M_BDTGA_4.root --fileNameToys $dirinput$inputprefix$thissamplestr$inputsuffix --sweightoutputname $sweightsdiroutput$sweightsprefix$thissamplestr$inputsuffix --save $diroutput$massplotprefix$thissamplestr$inputsuffix --sweight >& $diroutput$outputprefix$thissamplestr$outputsuffix 
