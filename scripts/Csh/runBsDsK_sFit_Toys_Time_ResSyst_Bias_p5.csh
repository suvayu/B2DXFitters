...
set outputprefix = 'DsK_Toys_Full_TimeFitResult_2kSample_ResSyst_Bias_p5_'
...
while ($thissample < $2) 
    ...
    python ../runBs2DsKCPAsymmObsFitterOnData.py --toys --pereventmistag --configName Bs2DsKConfigForResSyst_Bias_p5 --pathToys $dir$inputprefix$thissamplestr$inputsuffix >& $dir$outputprefix$thissamplestr$outputsuffix 
