set dirinput =  '/afs/cern.ch/work/a/adudziak/public/Bs2DsKToys/Gamma70_5M_NoPETE/'
set diroutput = '/afs/cern.ch/work/a/adudziak/public/Bs2DsKToys/Gamma70_5M_NoPETE/'
...
while ($thissample < $2) 
    ...
    python runBsDsKMassFitterOnData3D5M.py --debug --merge -m both -o all --configName Bs2DsKConfigForNominalMassFitToys5M --fileName /afs/cern.ch/work/a/adudziak/public/workspace/MDFitter/work_dsk_pid_53005800_PIDK5_5M_BDTGA.root --fileNameToys $dirinput$inputprefix$thissamplestr$inputsuffix --sweightoutputname $diroutput$sweightsprefix$thissamplestr$inputsuffix --save $diroutput$massplotprefix$thissamplestr$inputsuffix --sweight >& $diroutput$outputprefix$thissamplestr$outputsuffix 
