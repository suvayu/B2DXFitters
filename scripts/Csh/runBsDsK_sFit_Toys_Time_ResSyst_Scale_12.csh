...
set outputprefix = 'DsK_Toys_Full_TimeFitResult_2kSample_ResSyst_Scale_12_'
...
while ($thissample < $2) 
    ...
    python ../runBs2DsKCPAsymmObsFitterOnData.py --toys --pereventmistag --configName Bs2DsKConfigForResSyst_Scale_12 --pathToys $dir$inputprefix$thissamplestr$inputsuffix >& $dir$outputprefix$thissamplestr$outputsuffix 
