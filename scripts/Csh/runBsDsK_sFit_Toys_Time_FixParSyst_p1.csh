...
set diroutput = '/afs/cern.ch/work/g/gligorov/public/Bs2DsKToys/Systematics/TagCalib_p1_'
set diroutputsuffix = "/" 

set outputprefix = 'DsK_Toys_TimeFitResult_FixParSyst_p1_'
set outputsuffix = '.log'

set inputprefix = 'DsK_Toys_sWeights_ForTimeFit_'
set inputsuffix = '.root'

set configname = 'Bs2DsKConfigForFixedParamSyst_p1_'
