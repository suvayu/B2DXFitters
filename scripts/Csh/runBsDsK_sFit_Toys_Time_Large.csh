...
set outputprefix = 'DsK_Toys_FullLarge_TimeFitResult_'
set outputsuffix = '.log'

set inputprefix = 'DsK_Toys_FullLarge_sWeights_ForTimeFit_'
set inputsuffix = '.root'

set timeplotprefix = 'DsK_Toys_FullLarge_Work_TimeFitResult_'
