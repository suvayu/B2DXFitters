...
set outputprefix = 'DsK_Toys_Full_TimeFitResult_2kSample_Syst_Acceptance_BinCorr'
...
while ($thissample < $2) 
    ...
    python ../runBs2DsKCPAsymmObsFitterOnData.py --toys --pereventmistag --smearAccept --pathToys $dir$inputprefix$thissamplestr$inputsuffix --save $dir$timeplotprefix$thissamplestr$inputsuffix  >& $dir$outputprefix$thissamplestr$outputsuffix 
