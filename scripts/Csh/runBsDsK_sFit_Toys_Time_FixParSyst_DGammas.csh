...
set diroutput = '/afs/cern.ch/work/g/gligorov/public/Bs2DsKToys/Systematics/DGammas_'
set diroutputsuffix = "/"

set outputprefix = 'DsK_Toys_TimeFitResult_FixParSyst_DGammas_'
set outputsuffix = '.log'

set inputprefix = 'DsK_Toys_sWeights_ForTimeFit_'
set inputsuffix = '.root'

set configname = 'Bs2DsKConfigForFixedParamSyst_DGammas_'
