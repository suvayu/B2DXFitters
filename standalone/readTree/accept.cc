...
int main()
{
  ...
  for (unsigned i = 0; i < 2; ++i) {
    ...
    if (doSelect) {
      bool DsK(i < 1);
      string tuplename((i < 1) ? "/afs/cern.ch/work/a/adudziak/public/Merged_Bs2DsK*BsHypo_BDTG.root/DecayTree" :
		       "/afs/cern.ch/work/a/adudziak/public/Merged_Bs2DsPi*BsHypo_BDTG.root/DecayTree");
