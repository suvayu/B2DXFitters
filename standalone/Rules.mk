...
STDOPTFLAGS.GNU ?= -O3 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.Clang ?= -O3 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.Intel ?= -O3 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.Open64 ?= -O3 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.PathScale ?= -O3 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.SunPro ?= -O5 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
STDOPTFLAGS.Unknown ?= -O2 -fno-omit-frame-pointer # -DBOOST_DISABLE_ASSERTS -DNDEBUG
